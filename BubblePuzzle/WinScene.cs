...
namespace BubblePuzzle
{
    public class WinScene : Scene
    {
        ...
        public WinScene(ContentManager content, GraphicsDevice graphicsDevice, int score, int bestScore, float elapsedTime, Action onReturnToMenu)
        {
            ...
            this.score = score;
            // For win, update best score if not set.
            this.bestScore = (bestScore == 0) ? score : Math.Max(bestScore, score);
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            Vector2 winSize = headerFont.MeasureString(winText);
            Vector2 winPos = new Vector2((500 - winSize.X) / 2, 220);
            spriteBatch.DrawString(headerFont, winText, winPos, Color.Black);
